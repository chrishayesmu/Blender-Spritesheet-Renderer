...
class Bounds:
    ...
    def encapsulate(self, other):
        ...
        values_by_axis = list(zip(self.min_point, self.max_point, other.minPoint, other.maxPoint))
    ...
    @staticmethod
    def from_min_and_max_points(min_point, max_point):
    ...
    @staticmethod
    def _distance_by_axis(point1, point2):
